...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=8cm]{pictures/logo}
\end{center}
\end{figure}
...
\vspace*{0.6in}
\begin{large}
LICENCIATURA EN ECONOM\'IA.\\
\end{large}
\vspace*{0.2in}
\begin{Large}
\textbf{ECONOMETR\'IA I.} \\
\end{Large}
\vspace*{0.3in}
\begin{large}
GU\'IA DE EJERCICIOS COMPLEMENTARIOS.\\
\end{large}
\vspace*{0.3in}
\rule{80mm}{0.1mm}\\
\vspace*{0.1in}
...
\begin{scriptsize} 
Legajo: 37.693.722 \\ Email: \href{mailto:kevingston47@gmail.com}{kevingston47@gmail.com} \\
\end{scriptsize}
\vspace*{1.0in}
Agosto 2018\\
\end{large}
