...
En la figura \ref{F:uni2}, se esboza la distribución espacial de las universidades nacionales en el territorio. Vemos que la mayor cantidad está ubicada en la provincia de Buenos Aires, esto podemos relacionarlo con la distribución de la población, ya que antes mencionamos que está provincia es la que más población concentra, seguida por la provincia de Córdoba.
