...
######### Datos  #########
PBG <- read_excel("~/Dropbox/Kevin Mansilla/Datos/Base.xlsx",
                  sheet = "PBG")

Pop_por_provincia <- read_excel("~/Dropbox/Kevin Mansilla/Datos/Base.xlsx", 
                        sheet = "Pop_por_provincia")

Index_capital_hum <- read_excel("~/Dropbox/Kevin Mansilla/Datos/Base.xlsx", 
                        sheet = "Index_capital_hum")

#Id para chequear 
Id <- read_excel("~/Dropbox/Kevin Mansilla/Datos/Base.xlsx", 
                        sheet = "Id_Provincias")
